...
posts.items.forEach((post) => {
 ...
 readFile(rssFileName, 'utf-8', function (err, contents) {
  ...
  const nameSpace = typeReplaced.replaceAll('<rss version="2.0">', '<rss xmlns:media="http://search.yahoo.com/mrss/" xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:spotify="http://www.spotify.com/ns/rss" xmlns:psc="http://podlove.org/simple-chapters/" version="2.0">');
  const length  = nameSpace.replaceAll('length="0"', 'length="123456"');
  const author  = length.replaceAll('<channel>', '<channel>\n<author>info@waihekeradio.org.nz (Waiheke Radio) </author>\n<language>en</language>\n<itunes:image href="https://www.waihekeradio.org.nz/logo.png"/>\n<itunes:category text="Community Radio"></itunes:category><itunes:type>episodic</itunes:type>\n<spotify:countryOfOrigin>NZ-AUK</spotify:countryOfOrigin>');
