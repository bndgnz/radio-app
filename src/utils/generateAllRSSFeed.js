...
posts.items.forEach((post) => {
 ...
 readFile(rssFileName, 'utf-8', function (err, contents) {
  ...
  const replaced = contents.replace('<channel\>', '\<channel\>\n\<atom:link href="'+site_url+'/rss.xml" type="application/rss+xml"  rel="self" />');
  const typeReplaced = replaced.replaceAll('type="image/mp3"', 'type="audio/mpeg"');
  const nameSpace = typeReplaced.replaceAll('<rss version="2.0">', '<rss xmlns:atom="http://www.w3.org/2005/Atom"  xmlns:podcast="https://podcastindex.org/namespace/1.0" xmlns:dcterms="http://purl.org/dc/terms/" xmlns:spotify="http://www.spotify.com/ns/rss" xmlns:psc="http://podlove.org/simple-chapters/" xmlns:itunes="http://www.itunes.com/dtds/podcast-1.0.dtd" xmlns:media="http://search.yahoo.com/mrss/" version="2.0">');
  const length  = nameSpace.replaceAll('length="0"', 'length="4123456"');
  const author  = length.replaceAll('<channel>', '<channel>\n<spotify:countryOfOrigin>NZ-AUK</spotify:countryOfOrigin>\n<itunes:owner>\n<itunes:name>Waiheke Radio</itunes:name>\n<itunes:email>admin@waihekeradio.org.nz</itunes:email>\n</itunes:owner>\n<itunes:explicit>false</itunes:explicit>\n<language>en</language>\n<itunes:image href="https://www.waihekeradio.org.nz/logo.png"/>\n<itunes:category text="Arts" />\n<itunes:type>episodic</itunes:type>\n<itunes:author>Waiheke Radio</itunes:author><itunes:keywords>Waiheke Island Auckland New Zealand Community Radio station arts music interviews local content artists Artworks Oneroa culture</itunes:keywords>\n');
